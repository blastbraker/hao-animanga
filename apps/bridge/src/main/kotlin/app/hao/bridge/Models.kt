...
@Serializable data class InstallRequest(val repositoryUrl: String, val mediaKind: MediaKind, val packageInfo: ExtensionPackage, val acknowledged: Boolean)
@Serializable data class InstalledPackage(val packageName: String, val version: String, val sha256: String, val signerFingerprint: String?, val localPath: String)
